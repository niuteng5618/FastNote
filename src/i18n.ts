...
const dict = {
  zh: {
    ...
    'theme.sourceLineNumbers': '源码行号',
    'theme.defaultOutlineTab': '默认显示大纲',
    'theme.defaultOutlineTab.tip': '开启后，左侧库面板启动时默认打开大纲页签，而不是目录页签',
    'theme.symbolAutoCompletion': '自动补全',
    'theme.symbolAutoCompletion.tip': '关闭后，源码模式与所见模式不再自动补全括号、引号、星号、反引号等符号',
    'theme.wysiwygHtmlTable': 'HTML表格编辑',
    'theme.wysiwygHtmlTable.tip': '所见模式把 <table> 转为 Markdown 表格（会改写内容）',
    'theme.pasteUrlTitleFetch': '抓取网页标题',
    'theme.pasteUrlTitleFetch.tip': '开启后：Ctrl+V 粘贴 URL 自动抓取标题；可用 Ctrl+Shift+V 临时禁用抓取',
    'theme.pasteRemoteImages': '下载网页图片',
    'theme.pasteRemoteImages.tip': '开启后：从网页复制富文本时，远程图片会保存到当前文档同目录 images/ 并写入相对路径',
    'theme.updateCheckDisabled': '关闭更新检测',
    'theme.updateCheckDisabled.tip': '开启后，启动时和点击更新按钮都不再检查新版本',
    'theme.darkMode': '夜间模式',
    ...
    'theme.networkSection': '网络设置',
    'theme.netProxy.enable': '启用网络代理',
    'theme.netProxy.url': '代理地址',
    'theme.netProxy.noProxy': '不走代理',
    'theme.netProxy.apply': '应用代理',
    'theme.netProxy.tip': '仅支持 http/https 代理（例如 http://127.0.0.1:7890）。修改后对新请求生效；如仍无效，建议重启应用。',
    'theme.netProxy.errEmpty': '代理地址不能为空',
    'theme.netProxy.errScheme': '仅支持 http/https 代理地址',
    'theme.netProxy.errApplyFailed': '应用代理失败',
    'menu.plugins.manage': '菜单管理',
    'update.checkDisabled': '更新检测已关闭',
    ...
    'lib.choose': '库管理',
    'lib.settings.title': '库设置',
    'lib.settings.current': '当前库',
    'lib.settings.sidebar': '库切换器显示',
    'lib.settings.sidebar.short': '显示',
    'lib.settings.switcher': '库切换位置',
    'lib.settings.switcher.ribbon': '垂直标题栏',
    'lib.settings.switcher.sidebar': '侧栏内',
    'lib.settings.switcher.hint': '多库切换图标显示位置',
    'lib.settings.webdav.hint': '只配置当前库；账号/地址等详细项可在 WebDAV 设置中调整',
    'lib.settings.webdav.root': '远端路径',
    'lib.settings.webdav.root.hint': '留空时默认使用库名；为兼容老用户，已配置的库不会被强行改成库名路径',
    'lib.settings.webdav.open': '打开 WebDAV 详细设置…',
    'lib.settings.order': '库顺序与侧栏显示',
    'lib.settings.order.up': '上移',
    'lib.settings.order.down': '下移',
    'lib.settings.add': '新增库…',
    'lib.settings.rename': '重命名',
    'lib.settings.remove': '删除',
    'lib.settings.remove.confirm': '确认删除库“{name}”？此操作只会从列表移除，不会删除磁盘文件。',
    'lib.settings.added': '已新增',
    'lib.settings.renamed': '已重命名',
    'lib.settings.removed': '已删除',
    'lib.settings.empty': '暂无库',
    'lib.refresh': '刷新',
    ...
    // 退出确认
    'dlg.exit.title': '退出确认',
    'dlg.exit.unsaved': '检测到有文档存在未保存的更改',
    'dlg.exit.save': '保存并退出',
    ...
    'upl.localPreferRelative': '本地图片写入相对路径',
    'upl.hint.alwaysLocal': '开启后，无论图床是否启用，粘贴/拖拽/链接插入的图片都会复制到当前文档同目录的 images 文件夹，并立即生效',
    'upl.hint.localPreferRelative': '开启后，在“保存到当前文档 images/”的场景下，插入 Markdown 将使用 images/xxx.png 形式（更适合跨设备同步）；不影响图床外链与已有文档内容',
    'upl.hint.webdavDragImport': '提示：开启 WebDAV 同步后，拖拽本地图片会默认导入到当前文档同目录的 images 文件夹，以确保跨设备可见（不受“总是保存到本地”开关影响）',
    'upl.ak': 'AccessKeyId',
    'upl.ak.ph': '必填',
    ...
    'sync.logRetention.label': '日志保留(天)',
    'sync.logRetention.hint': '默认 7 天；建议 7–14 天，太长只是在攒垃圾',
    'sync.logRetention.hintView': '日志保留 {days} 天',
    ...
    'sync.openlog': '同步记录',
    'sync.logViewer.title': '同步日志',
    'sync.logViewer.clear': '清空',
    'sync.logViewer.latest': '查看最新日志',
    'sync.logViewer.empty': '暂无同步日志',
    'sync.logViewer.clearConfirm': '确定清空同步日志？',
    'sync.now': '立即同步(F5)',
    'sync.save': '保存',
    ...
    'ctx.revealInExplorer': '在资源管理器打开',
    'ctx.moveTo': '移动到',
    'ctx.pastePlain': '纯文本粘贴',
    'ctx.copyRichEmbed': '复制为富文本（内嵌图片）',
    'ctx.copyImage': '复制图片',
    'ctx.copyImageLink': '复制图片链接',
    'ctx.table.deleteRow': '删除行',
    'ctx.table.deleteColumn': '删除列',
    'ctx.openNewInstance': '在新实例中打开',
    'ctx.createSticky': '生成便签',
    'ctx.rename': '重命名',
    'ctx.delete': '删除',
    'ctx.sortByName': '按名称排序',
    'ctx.sortByTime': '按修改时间排序',
    ...
    'ext.markdownTable.author': '作者：FastNote',
    ...
    'ext.pdf2doc.author': '作者：FastNote',
    'ext.pdf2doc.desc': '使用大模型高精度识别解析 PDF 为 Markdown 或 docx，支持手写、布局、公式和表格识别。',
    'ext.whiteboardView.name': '白板视图',
    'ext.whiteboardView.author': '作者：FastNote',
    'ext.whiteboardView.desc': '在可视化画布上摆放 Markdown 笔记节点并建立简单连接。',
    'diaryTasks.title': '日记与待办',
    'diaryTasks.open.tip': '日历与待办',
    'diaryTasks.tab.todo': '待办',
    'diaryTasks.tab.diary': '日记',
    'diaryTasks.add': '写待办',
    'diaryTasks.continueTodo': '继续写待办',
    'diaryTasks.addDiary': '写日记',
    'diaryTasks.continueDiary': '继续写日记',
    'diaryTasks.today': '今天',
    'diaryTasks.refresh': '刷新',
    'diaryTasks.prevMonth': '上月',
    'diaryTasks.nextMonth': '下月',
    'diaryTasks.month': '{n} 月',
    'diaryTasks.year': '{n} 年',
    'diaryTasks.legend.open': '未完成',
    'diaryTasks.legend.done': '已完成',
    'diaryTasks.legend.overdue': '逾期',
    'diaryTasks.legend.diary': '日记',
    'diaryTasks.status.all': '全部',
    'diaryTasks.status.open': '未完成',
    'diaryTasks.status.done': '已完成',
    'diaryTasks.status.overdue': '逾期',
    'diaryTasks.badge.open': '未完成',
    'diaryTasks.badge.done': '已完成',
    'diaryTasks.badge.overdue': '逾期',
    'diaryTasks.search': '搜索标题 / 内容',
    'diaryTasks.selectAll': '全选',
    'diaryTasks.scopeMonthHint': '本月全部（{m}），点日期只看当天',
    'diaryTasks.scopeDate': '筛选日期：{d}',
    'diaryTasks.more.todo': '+{n} 项',
    'diaryTasks.more.diary': '+{n} 篇',
    'diaryTasks.empty.todo': '没有匹配的待办。',
    'diaryTasks.empty.diary': '这段时间还没有日记。',
    'diaryTasks.count.todo': '待办 {n} 条',
    'diaryTasks.count.diary': '日记 {n} 篇',
    'diaryTasks.scanning': '正在扫描…',
    'diaryTasks.scanFailed': '扫描失败，请查看控制台。',
    'diaryTasks.markDone': '标记完成',
    'diaryTasks.markOpen': '标记未完成',
    'diaryTasks.pushXxtui': '推送到 xxtui',
    'diaryTasks.createReminders': '创建提醒',
    'diaryTasks.needLibrary': '请先打开一个笔记库 / 文件夹。',
    'diaryTasks.needSelect': '请先勾选要操作的任务。',
    'diaryTasks.markedDone': '已标记 {n} 条为已完成',
    'diaryTasks.markedOpen': '已标记 {n} 条为未完成',
    'diaryTasks.markFailed': '未能标记任何任务，请检查这些行是否为标准待办语法（- [ ] / - [x]）。',
    'diaryTasks.editor.newTodo': '新建待办',
    'diaryTasks.editor.editTodo': '编辑待办',
    'diaryTasks.editor.newDiary': '新建日记',
    'diaryTasks.editor.editDiary': '编辑日记',
    'diaryTasks.editor.newTip': '还没有这一天，将按模板新建（要换日期请先在日历里选）',
    'diaryTasks.editor.continueTip': '继续编辑这一天的内容',
    'diaryTasks.editor.save': '保存',
    'diaryTasks.editor.cancel': '取消',
    'diaryTasks.editor.hint': 'Ctrl+S 保存，Esc 取消。内容将保存到 {path}',
    'diaryTasks.editor.discard': '当前内容尚未保存，确定放弃修改吗？',
    'diaryTasks.editor.failed': '保存失败，请查看控制台。',
    'diaryTasks.saved': '已保存到 {path}',
    'diaryTasks.tpl.title': '模板',
    'diaryTasks.tpl.todo': '待办模板',
    'diaryTasks.tpl.diary': '日记模板',
    'diaryTasks.tpl.hint': '新建待办 / 日记时使用。支持变量：{{date}} {{year}} {{month}} {{day}} {{datetime}} {{weekday}} {{lunar}} {{title}}',
    'diaryTasks.tpl.reset': '恢复默认',
    'diaryTasks.tpl.save': '保存',
    'diaryTasks.tpl.saved': '模板已保存',
    'diaryTasks.tpl.resetDone': '已恢复默认模板',
    'diaryTasks.tpl.todoTip': '待办条目写成 - [ ] 开头即可；日期取文件名（或条目里写 @2026-09-24）。',
    'diaryTasks.tpl.diaryTip': '日期取文件名，模板里不必再写日期字段。',
    'diaryTasks.tpl.path': '保存位置：<库根>/日记与待办/{month}/{date}-待办.md（日记同理）',
    'diaryTasks.err.xxtui': 'xxtui 待办推送插件不可用，请先启用该插件。',
    'diaryTasks.err.pushNone': '请先勾选要推送的任务。',
    'diaryTasks.err.pushFail': '推送失败，请检查 xxtui 配置。',
    'diaryTasks.pushOk': '已推送 {n} 条',
    'diaryTasks.remindOk': '已创建提醒 {n} 条',
    'diaryTasks.err.remindFail': '创建提醒失败。',
    'ext.blinkoSnap.name': '发送到 Blinko',
    'ext.blinkoSnap.author': '作者：FastNote',
    'ext.blinkoSnap.desc': '右键菜单一键将当前内容发送到 Blinko。',
    'ext.floatingToolbar.name': '富文本悬浮工具条',
    'ext.floatingToolbar.author': '作者：FastNote',
    'ext.floatingToolbar.desc': '提供可拖拽且可吸附到顶部的悬浮工具条，并支持自定义标题快捷键等编辑增强功能。',
    'ext.propertyView.name': '属性视图',
    'ext.propertyView.author': '作者：FastNote',
    ...
    'ext.localCollab.author': '作者：FastNote',
    ...
    'plugins.menuManager.col.ribbon': '垂直菜单栏',
    'plugins.menuManager.col.ribbonPos': '位置',
    'plugins.menuManager.col.ribbonOrder': '顺序',
    'plugins.menuManager.ribbonPos.top': '顶部',
    'plugins.menuManager.ribbonPos.bottom': '底部',
    'plugins.menuManager.ribbonOrder.up': '上移',
    'plugins.menuManager.ribbonOrder.down': '下移',
  ...
  en: {
    ...
    'theme.sourceLineNumbers': 'Source line numbers',
    'theme.defaultOutlineTab': 'Default outline tab',
    'theme.defaultOutlineTab.tip': 'When enabled, the left library panel opens the outline tab by default instead of the files tab',
    'theme.symbolAutoCompletion': 'Autocomplete',
    'theme.symbolAutoCompletion.tip': 'When disabled, source and WYSIWYG modes no longer autocomplete brackets, quotes, asterisks, backticks, and similar symbols',
    ...
    'theme.pasteUrlTitleFetch': 'Fetch page title',
    'theme.pasteUrlTitleFetch.tip': 'When enabled: Ctrl+V on a URL fetches the page title; use Ctrl+Shift+V to paste without fetching',
    'theme.pasteRemoteImages': 'Download web images',
    'theme.pasteRemoteImages.tip': 'When enabled: pasted rich HTML saves remote images to images/ next to the current document and writes relative paths',
    'theme.updateCheckDisabled': 'Disable update checks',
    'theme.updateCheckDisabled.tip': 'When enabled, FastNote will not check for new versions on startup or from the update button',
    ...
    'theme.networkSection': 'Network',
    'theme.netProxy.enable': 'Enable proxy',
    'theme.netProxy.url': 'Proxy URL',
    'theme.netProxy.noProxy': 'No proxy',
    'theme.netProxy.apply': 'Apply proxy',
    'theme.netProxy.tip': 'HTTP/HTTPS proxies only (e.g. http://127.0.0.1:7890). Changes apply to new requests; restart if needed.',
    'theme.netProxy.errEmpty': 'Proxy URL is required',
    'theme.netProxy.errScheme': 'Only HTTP/HTTPS proxy URLs are supported',
    'theme.netProxy.errApplyFailed': 'Failed to apply proxy',
    'menu.plugins.manage': 'Menu Manager',
    'update.checkDisabled': 'Update checks are disabled',
    ...
    'lib.choose': 'Manage',
    'lib.settings.title': 'Library Settings',
    'lib.settings.current': 'Current',
    'lib.settings.sidebar': 'Show In Switcher',
    'lib.settings.sidebar.short': 'Show',
    'lib.settings.switcher': 'Switcher Position',
    'lib.settings.switcher.ribbon': 'Ribbon',
    'lib.settings.switcher.sidebar': 'Sidebar',
    'lib.settings.switcher.hint': 'Where to display library switch icons',
    'lib.settings.webdav.hint': 'Applies to the current library only; use WebDAV settings for full configuration',
    'lib.settings.webdav.root': 'Remote Path',
    'lib.settings.webdav.root.hint': 'Empty uses the library name by default; existing configured libraries keep legacy behavior for compatibility',
    'lib.settings.webdav.open': 'Open WebDAV Settings…',
    'lib.settings.order': 'Order & Sidebar Visibility',
    'lib.settings.order.up': 'Move up',
    'lib.settings.order.down': 'Move down',
    'lib.settings.add': 'Add Library…',
    'lib.settings.rename': 'Rename',
    'lib.settings.remove': 'Remove',
    'lib.settings.remove.confirm': 'Remove library \"{name}\"? This only removes it from the list and will not delete files on disk.',
    'lib.settings.added': 'Added',
    'lib.settings.renamed': 'Renamed',
    'lib.settings.removed': 'Removed',
    'lib.settings.empty': 'No libraries',
    'lib.refresh': 'Refresh',
    ...
    'dlg.exit.unsaved': 'Unsaved changes detected in open documents',
    ...
    'upl.localPreferRelative': 'Use relative paths for local images',
    ...
    'upl.hint.localPreferRelative': 'When enabled, if an image is saved into the current document\'s images/ folder, the inserted Markdown uses images/xxx.png (better for sync). Does not affect remote image URLs or existing content.',
    'upl.hint.webdavDragImport': 'Tip: When WebDAV sync is enabled, dragged local images are imported into the current document\'s images folder by default so they stay visible across devices (regardless of the “Always save locally” toggle).',
    'upl.ak': 'AccessKeyId',
    'upl.ak.ph': 'Required',
    'upl.sk': 'SecretAccessKey',
    'upl.sk.ph': 'Required',
    ...
    'sync.logRetention.label': 'Log Retention (days)',
    'sync.logRetention.hint': 'Default 7 days; recommended 7–14',
    'sync.logRetention.hintView': 'Retention: {days} days',
    ...
    'sync.logViewer.title': 'Sync Log',
    'sync.logViewer.clear': 'Clear',
    'sync.logViewer.latest': 'Jump to Latest',
    'sync.logViewer.empty': 'No sync log yet',
    'sync.logViewer.clearConfirm': 'Clear the sync log?',
    ...
    'ctx.revealInExplorer': 'Show in File Manager',
    'ctx.moveTo': 'Move to',
    'ctx.pastePlain': 'Paste as Plain Text',
    'ctx.copyRichEmbed': 'Copy as Rich Text (embed images)',
    'ctx.copyImage': 'Copy Image',
    'ctx.copyImageLink': 'Copy Image Link',
    ...
    'ctx.rename': 'Rename',
    'ctx.delete': 'Delete',
    'ctx.sortByName': 'Sort by name',
    'ctx.sortByTime': 'Sort by modified time',
    ...
    'ext.wordcount.author': 'By: FastNote',
    ...
    'ext.todoPush.author': 'By: FastNote & xxtui',
    ...
    'ext.markdownTable.author': 'By: FastNote',
    ...
    'ext.gitHistory.author': 'By: FastNote',
    ...
    'ext.backlinks.author': 'By: FastNote',
    ...
    'ext.graphView.author': 'By: FastNote',
    ...
    'ext.officeImporter.author': 'By: FastNote',
    ...
    'ext.s3Gallery.author': 'By: FastNote',
    ...
    'ext.autoyaml.author': 'By: FastNote',
    ...
    'ext.typechoManager.author': 'By: FastNote',
    ...
    'ext.pdf2doc.author': 'By: FastNote',
    ...
    'ext.whiteboardView.author': 'By: FastNote',
    'ext.whiteboardView.desc': 'Place Markdown note nodes on a visual canvas and connect them with simple links.',
    'diaryTasks.title': 'Journals & Todos',
    'diaryTasks.open.tip': 'Calendar & Todos',
    'diaryTasks.tab.todo': 'Todos',
    'diaryTasks.tab.diary': 'Journals',
    'diaryTasks.add': 'Write todo',
    'diaryTasks.continueTodo': 'Continue todo',
    'diaryTasks.addDiary': 'Write journal',
    'diaryTasks.continueDiary': 'Continue journal',
    'diaryTasks.today': 'Today',
    'diaryTasks.refresh': 'Refresh',
    'diaryTasks.prevMonth': 'Previous month',
    'diaryTasks.nextMonth': 'Next month',
    'diaryTasks.month': '{n}',
    'diaryTasks.year': '{n}',
    'diaryTasks.legend.open': 'Open',
    'diaryTasks.legend.done': 'Done',
    'diaryTasks.legend.overdue': 'Overdue',
    'diaryTasks.legend.diary': 'Journal',
    'diaryTasks.status.all': 'All',
    'diaryTasks.status.open': 'Open',
    'diaryTasks.status.done': 'Done',
    'diaryTasks.status.overdue': 'Overdue',
    'diaryTasks.badge.open': 'Open',
    'diaryTasks.badge.done': 'Done',
    'diaryTasks.badge.overdue': 'Overdue',
    'diaryTasks.search': 'Search title / text',
    'diaryTasks.selectAll': 'All',
    'diaryTasks.scopeMonthHint': 'Whole month ({m}) — click a day to filter',
    'diaryTasks.scopeDate': 'Date: {d}',
    'diaryTasks.more.todo': '+{n}',
    'diaryTasks.more.diary': '+{n}',
    'diaryTasks.empty.todo': 'No matching todos.',
    'diaryTasks.empty.diary': 'No journals in this range.',
    'diaryTasks.count.todo': '{n} todos',
    'diaryTasks.count.diary': '{n} journals',
    'diaryTasks.scanning': 'Scanning…',
    'diaryTasks.scanFailed': 'Scan failed, see console.',
    'diaryTasks.markDone': 'Mark done',
    'diaryTasks.markOpen': 'Mark open',
    'diaryTasks.pushXxtui': 'Push to xxtui',
    'diaryTasks.createReminders': 'Create reminders',
    'diaryTasks.needLibrary': 'Please open a library / folder first.',
    'diaryTasks.needSelect': 'Please select todos first.',
    'diaryTasks.markedDone': 'Marked {n} todos as done',
    'diaryTasks.markedOpen': 'Marked {n} todos as open',
    'diaryTasks.markFailed': 'No todos were marked. Please check if lines use "- [ ]" / "- [x]" syntax.',
    'diaryTasks.editor.newTodo': 'New todo',
    'diaryTasks.editor.editTodo': 'Edit todo',
    'diaryTasks.editor.newDiary': 'New journal',
    'diaryTasks.editor.editDiary': 'Edit journal',
    'diaryTasks.editor.newTip': 'Nothing for this day yet — pick the day in the calendar to switch',
    'diaryTasks.editor.continueTip': 'Continue editing this day',
    'diaryTasks.editor.save': 'Save',
    'diaryTasks.editor.cancel': 'Cancel',
    'diaryTasks.editor.hint': 'Ctrl+S to save, Esc to cancel. Saved to {path}',
    'diaryTasks.editor.discard': 'The current content is not saved. Discard the changes?',
    'diaryTasks.editor.failed': 'Save failed, see console.',
    'diaryTasks.saved': 'Saved to {path}',
    'diaryTasks.tpl.title': 'Templates',
    'diaryTasks.tpl.todo': 'Todo template',
    'diaryTasks.tpl.diary': 'Journal template',
    'diaryTasks.tpl.hint': 'Used when creating todos / journals. Variables: {{date}} {{year}} {{month}} {{day}} {{datetime}} {{weekday}} {{lunar}} {{title}}',
    'diaryTasks.tpl.reset': 'Reset to default',
    'diaryTasks.tpl.save': 'Save',
    'diaryTasks.tpl.saved': 'Templates saved',
    'diaryTasks.tpl.resetDone': 'Default template restored',
    'diaryTasks.tpl.todoTip': 'Write each item as a line starting with - [ ]; the date comes from the file name (or from @2026-09-24 in the item).',
    'diaryTasks.tpl.diaryTip': 'The date comes from the file name — no date field needed in the template.',
    'diaryTasks.tpl.path': 'Saved to <library root>/日记与待办/{month}/{date}-待办.md (same for journals)',
    'diaryTasks.err.xxtui': 'The xxtui todo push plugin is not available. Please enable it first.',
    'diaryTasks.err.pushNone': 'Please select todos to push.',
    'diaryTasks.err.pushFail': 'Push failed, please check the xxtui configuration.',
    'diaryTasks.pushOk': 'Pushed {n} todos',
    'diaryTasks.remindOk': 'Created {n} reminders',
    'diaryTasks.err.remindFail': 'Failed to create reminders.',
    'ext.blinkoSnap.name': 'Send to Blinko',
    'ext.blinkoSnap.author': 'By: FastNote',
    ...
    'ext.floatingToolbar.author': 'By: FastNote',
    ...
    'ext.propertyView.author': 'By: FastNote',
    ...
    'ext.localCollab.author': 'By: FastNote',
    ...
    'plugins.menuManager.col.ribbon': 'Ribbon',
    'plugins.menuManager.col.ribbonPos': 'Position',
    'plugins.menuManager.col.ribbonOrder': 'Order',
    'plugins.menuManager.ribbonPos.top': 'Top',
    'plugins.menuManager.ribbonPos.bottom': 'Bottom',
    'plugins.menuManager.ribbonOrder.up': 'Move Up',
    'plugins.menuManager.ribbonOrder.down': 'Move Down',
